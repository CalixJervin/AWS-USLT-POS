...
export function AddProductModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[480px] w-[calc(100%-32px)] p-0 overflow-hidden bg-[#1E2333] border border-[#2D3448] rounded-[16px] shadow-2xl max-h-[85vh] sm:max-h-[90vh] flex flex-col text-[#E2E8F0] overscroll-contain">
